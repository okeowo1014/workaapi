...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='applyjob',
            name='applicant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_applicant',
                                    to='api.employee'),
        ),
        migrations.AlterField(
            model_name='applyjob',
        ...
        migrations.AlterField(
            model_name='jobspost',
            name='employer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='job_employer',
                                    to='api.employer'),
        ),
        migrations.AlterField(
            model_name='jobspost',
